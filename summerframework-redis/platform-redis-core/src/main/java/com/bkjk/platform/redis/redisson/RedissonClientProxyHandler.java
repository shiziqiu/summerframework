...
import static com.bkjk.platform.redis.jedis.SerializerUtil.getValueSize;
...
import com.bkjk.platform.redis.jedis.SerializerUtil;
...
public class RedissonClientProxyHandler implements InvocationHandler {
    ...
    private static RedisSerializer serializer = SerializerUtil.getDefaultSerializer();
    private RedissonClient redissonClient;

    public RedissonClientProxyHandler(RedissonClient redissonClient) {
    ...
    private Object doInvoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            result = method.invoke(redissonClient, args);
